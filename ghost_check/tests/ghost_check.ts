...
describe("ghost_check", () => {
  ...
  const Ed25519Signature = [
    92, 167, 49, 69, 200, 211, 252, 170, 164, 250, 78, 218, 173, 56, 242, 138,
    12, 50, 54, 231, 131, 87, 149, 97, 91, 152, 80, 248, 203, 86, 209, 72, 187,
    230, 90, 225, 203, 228, 115, 99, 80, 152, 252, 142, 57, 110, 74, 195, 227,
    20, 247, 18, 154, 137, 198, 106, 146, 249, 122, 80, 7, 144, 93, 2,
  ];

  const messageHash = Buffer.from([
    200, 114, 63, 63, 43, 42, 55, 100, 20, 181, 162, 91, 107, 174, 30, 175, 70,
    149, 43, 141, 68, 111, 173, 203, 16, 169, 89, 109, 53, 172, 154, 108,
  ]);

  // For Repo_Badge
  const Ed25519SignatureRepo = [
    246, 217, 229, 21, 127, 70, 69, 129, 61, 179, 31, 15, 245, 214, 138, 139,
    21, 159, 217, 226, 252, 3, 65, 19, 152, 219, 200, 142, 134, 228, 91, 3, 195,
    115, 202, 7, 18, 188, 124, 163, 69, 145, 146, 46, 161, 194, 53, 60, 26, 188,
    171, 79, 130, 248, 24, 131, 67, 164, 101, 152, 101, 234, 20, 12,
  ];
  const hashedMessageRepo = [
    252, 152, 237, 160, 153, 61, 109, 104, 203, 166, 128, 160, 55, 173, 242,
    124, 239, 43, 202, 116, 183, 111, 137, 186, 12, 64, 229, 126, 101, 186, 13,
    230,
  ];
